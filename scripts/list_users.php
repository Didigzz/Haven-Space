...
try {
    ...
    $stmt = $pdo->query("SELECT u.id, u.first_name, u.last_name, u.email, u.google_id, ur.role_name as role FROM users u JOIN user_roles ur ON u.role_id = ur.id ORDER BY u.id ASC");
