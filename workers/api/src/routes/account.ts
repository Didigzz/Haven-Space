...
accountRoutes.post('/auth/change-password.php', handleChangePassword);
accountRoutes.post('/auth/forgot-password', handleForgotPassword);
accountRoutes.post('/auth/forgot-password.php', handleForgotPassword);
accountRoutes.post('/auth/verify-reset-code', handleVerifyResetCode);
accountRoutes.post('/auth/verify-reset-code.php', handleVerifyResetCode);
accountRoutes.post('/auth/resend-reset-code', handleResendResetCode);
accountRoutes.post('/auth/resend-reset-code.php', handleResendResetCode);
accountRoutes.post('/auth/reset-password', handleResetPassword);
accountRoutes.post('/auth/reset-password.php', handleResetPassword);
accountRoutes.post('/auth/refresh-token', handleRefreshToken);
accountRoutes.post('/auth/refresh-token.php', handleRefreshToken);
accountRoutes.post('/auth/logout', c => clearAuthResponse(c.env));
accountRoutes.post('/auth/logout.php', c => clearAuthResponse(c.env));
