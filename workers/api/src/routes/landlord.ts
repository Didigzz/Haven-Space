...
landlordRoutes.post('/api/landlord/upload-photos.php', handleUploadTemporaryPropertyPhotos);
landlordRoutes.post('/api/landlord/listings/:id/photos', handleUploadListingPhotos);
landlordRoutes.post('/api/landlord/properties.php', handleCreateLandlordPropertyAlias);
landlordRoutes.get('/api/landlord/dashboard-stats', handleLandlordDashboardStats);
landlordRoutes.get('/api/landlord/dashboard-stats.php', handleLandlordDashboardStats);
landlordRoutes.get('/api/landlord/dashboard/stats', handleLandlordDashboardStats);
landlordRoutes.get('/api/landlord/boarders', handleListLandlordBoarders);
landlordRoutes.get('/api/landlord/boarders.php', handleListLandlordBoarders);
landlordRoutes.post('/api/landlord/boarders', handleCreateLandlordBoarder);
landlordRoutes.post('/api/landlord/boarders.php', handleCreateLandlordBoarder);
landlordRoutes.put('/api/landlord/boarders', handleUpdateLandlordBoarder);
landlordRoutes.put('/api/landlord/boarders.php', handleUpdateLandlordBoarder);
landlordRoutes.delete('/api/landlord/boarders', handleDeleteLandlordBoarder);
landlordRoutes.delete('/api/landlord/boarders.php', handleDeleteLandlordBoarder);
landlordRoutes.get('/api/landlord/rooms', handleListLandlordRooms);
landlordRoutes.get('/api/landlord/rooms.php', handleListLandlordRooms);
landlordRoutes.post('/api/landlord/rooms', handleCreateLandlordRoom);
landlordRoutes.post('/api/landlord/rooms.php', handleCreateLandlordRoom);
...
landlordRoutes.put('/api/landlord/rooms.php', handleUpdateLandlordRoom);
landlordRoutes.delete('/api/landlord/rooms', handleDeleteLandlordRoom);
landlordRoutes.delete('/api/landlord/rooms.php', handleDeleteLandlordRoom);
...
landlordRoutes.delete('/api/landlord/properties.php', handleDeleteLandlordProperty);
