...
deferredRoutes.all('/api/landlord/payment-overview.php', deferredPayments);
deferredRoutes.all('/api/landlord/payment-methods', deferredPayments);
deferredRoutes.all('/api/landlord/payment-methods.php', deferredPayments);
deferredRoutes.all('/api/landlord/payments', deferredPayments);
deferredRoutes.all('/api/landlord/payments.php', deferredPayments);
deferredRoutes.all('/api/landlord/payments/export', deferredPayments);
deferredRoutes.all('/api/landlord/payments-export.php', deferredPayments);
deferredRoutes.all('/api/landlord/payments-email-report.php', deferredPayments);
deferredRoutes.all('/api/landlord/payment-summary', deferredPayments);
deferredRoutes.all('/api/landlord/payment-summary.php', deferredPayments);
deferredRoutes.all('/api/landlord/send-reminder', deferredPayments);
deferredRoutes.all('/api/landlord/send-reminder.php', deferredPayments);
