...
function isProtectedPage() {
  ...
  const isAccessible = ALWAYS_ACCESSIBLE_PAGES.some(page => 
...
export function showProtectedEmptyState(container, feature) {
  ...
  const messages = {
    payments: {
      ...
      description: 'Your payment history will be available once your application is accepted by a landlord.',
      icon: 'creditCard',
    },
    messages: {
      title: 'Messages Unavailable',
      description: 'You can send and receive messages once your application is accepted by a landlord.',
      icon: 'chatBubble',
    },
    announcements: {
      title: 'No Announcements',
      description: 'Announcements from your landlord will appear here once your application is accepted.',
      icon: 'megaphone',
    },
    lease: {
