...
import { showExportModal } from './payment-export.ts';
...
async function loadPayments() {
  ...
  try {
    ...
    const response = await fetch(`${CONFIG.API_BASE_URL}/api/landlord/payments`, {
      method: 'GET',
      headers,
      credentials: 'include',
    });
...
async function loadPaymentSummary() {
  try {
    ...
    const response = await fetch(`${CONFIG.API_BASE_URL}/api/landlord/payment-summary`, {
      method: 'GET',
      headers,
      credentials: 'include',
    });
