import { initFindARoomEnhanced } from './find-a-room.ts';
import { redirectAuthenticatedUsers } from '../../shared/routing.ts';
...
function setupEventListeners() {
  ...
  // (chips are populated by loadPopularLocations in find-a-room.ts)
